...
class GenerationMetadata:
    ...
    def is_identical_generation(self, other: "GenerationMetadata") -> bool:
        ...
        return (
            self.seed_used == other.seed_used
            and self.schema_hash == other.schema_hash
            and self.total_records == other.total_records
            and self.entity_counts == other.entity_counts
            and self.output_formats == other.output_formats
        )
...
def calculate_schema_hash(schema: SystemSchema) -> str:
    ...
    for entity_name in sorted(schema.entities.keys()):
        ...
        entity_dict = {"name": entity.name, "count": entity.count, "attributes": {}}
