...
def main():
    ...
    parser.add_argument(
        "--force", action="store_true", help="Overwrite existing variables"
    )
    parser.add_argument("--list", action="store_true", help="List current variables")
    ...
    if not check_airflow_available():
        print(
            "❌ Airflow CLI not available. Make sure Airflow is installed and configured."
        )
