...
class TestParquetWriter:
    ...
    def test_write_with_datetime_objects(self, tmp_path: Path):
        ...
        assert str(event["created_at"]) == "2024-01-15T10:30:45" or event["created_at"] == test_datetime
        assert str(event["event_date"]) == "2024-01-15" or event["event_date"] == test_date
    ...
    def test_write_with_none_values(self, tmp_path: Path):
        ...
        assert df.iloc[0]["middle_name"] is None or str(df.iloc[0]["middle_name"]) == "nan"
