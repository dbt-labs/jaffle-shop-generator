...
class TestImportAirbyteCommand:
    ...
    def test_import_airbyte_success(self, runner: CliRunner, tmp_path: Path, sample_manifest):
    ...
    def test_import_airbyte_with_relationships(self, runner: CliRunner, tmp_path: Path, sample_manifest):
    ...
    def test_import_airbyte_without_relationships(self, runner: CliRunner, tmp_path: Path, sample_manifest):
    ...
    def test_import_airbyte_file_not_found(self, runner: CliRunner, tmp_path: Path):
        ...
        result = runner.invoke(app, [
            "import-airbyte",
            "--manifest-file", str(nonexistent_file),
            "--output-dir", str(schemas_dir)
        ])
    ...
    def test_import_airbyte_no_validation(self, runner: CliRunner, tmp_path: Path, sample_manifest):
    ...
    def test_import_airbyte_creates_output_directory(self, runner: CliRunner, tmp_path: Path, sample_manifest):
    ...
    def test_import_airbyte_summary_table(self, runner: CliRunner, tmp_path: Path, sample_manifest):
    ...
    def test_import_airbyte_next_steps(self, runner: CliRunner, tmp_path: Path, sample_manifest):
