...
"""
        ...
        assert generation_time < 40.0  # Should complete within 40 seconds
...
"""
        ...
        print(
            f"Generated 5,000 users with unique constraints in {generation_time:.2f} seconds"
        )
        if HAS_PSUTIL:
            print(f"Memory usage: {memory_used:.2f} MB")
        else:
...
"""
        ...
        print(
            f"Generated complex linked data (8,100 total records) in {total_time:.2f} seconds"
        )
...
"""
        ...
        print(
            f"Generated {total_records} records across 5 schemas in {total_time:.2f} seconds"
        )
...
"""
        ...
        print(
            f"Stress test: Generated 100,000 records in {generation_time:.2f} seconds"
        )
        if HAS_PSUTIL:
            print(f"Memory usage: {memory_used:.2f} MB")
        else:
...
"""
        ...
        schemas_to_test = [("simple", simple_schema), ("complex", complex_schema)]
        ...
        for schema_name, schema_content in schemas_to_test:
            ...
            print(
                f"{schema_name.capitalize()} schema generation: {generation_time:.3f} seconds"
            )
        ...
        complexity_ratio = (
            performance_results["complex"] / performance_results["simple"]
        )
