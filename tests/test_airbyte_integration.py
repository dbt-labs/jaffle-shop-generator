...
class TestAirbyteIntegration:
    ...
    def test_json_schema_type_mapping(self, sample_airbyte_manifest):
        ...
        assert (
            translator._map_json_schema_type(
                "integer", None, {"minimum": 0, "maximum": 120}
            )
            == "integer"
        )
    ...
    def test_complex_nested_schema_handling(
        self, tmp_path: Path, complex_airbyte_manifest
    ):
        ...
        assert any(
            "Object types not supported" in w.message
    ...
    def test_unsupported_features_warning(self, tmp_path: Path):
                    ...
                    "json_schema": {
                        ...
                        "properties": {
                            ...
                            "conditional_field": {
                                ...
                                "then": {
                                    "properties": {"premium_data": {"type": "string"}}
                                },
                                "else": {
                                    "properties": {"basic_data": {"type": "string"}}
                                },
                            },
                        },
                    },
        ...
        oneOf_warnings = [
            w
            for w in validation_result.warnings
            if "oneOf" in w.message or "Complex schema features" in w.message
        ]
    ...
    def test_end_to_end_airbyte_workflow(self, tmp_path: Path, sample_airbyte_manifest):
        ...
        loaded_schemas, validation_result = discovery_engine.discover_and_load_schemas(
            schemas_dir
        )
