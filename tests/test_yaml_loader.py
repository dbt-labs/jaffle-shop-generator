...
from jafgen.schema import SchemaLoadError, YAMLSchemaLoader
...
"""
    ...
    def test_validate_schema_missing_name(self):
        ...
        from jafgen.schema.models import OutputConfig, SystemSchema

        schema = SystemSchema(
            name="", version="1.0.0", output=OutputConfig(), entities={}  # Empty name
        )
                ...
                "orders": EntityConfig(
                    ...
                    attributes={
                        ...
                        "user_id": AttributeConfig(
                            type="link", link_to="test-system.users.id"
                        ),  # users entity doesn't exist
                    },
                )
            },
        )
...
"""
    ...
    def test_validate_schema_entity_without_attributes(self):
        ...
        from jafgen.schema.models import EntityConfig, OutputConfig, SystemSchema
        ...
        schema = SystemSchema(
            ...
            entities={
                "empty_entity": EntityConfig(
                    name="empty_entity", count=10, attributes={}  # No attributes
                )
            },
        )
