...
class TestJSONWriter:
    ...
    def test_write_with_uuid_objects(self, tmp_path: Path):
        ...
        data = {
            "users": [
                {"id": test_uuid, "name": "John Doe", "external_id": str(test_uuid)}
            ]
        }
...
class TestJSONWriterEdgeCases:
    ...
    def test_write_with_decimal_objects(self, tmp_path: Path):
        ...
        data = {
            "products": [{"id": 1, "price": Decimal("19.99"), "tax": Decimal("1.60")}]
        }
            ...
            "numbers": [
                {
                    ...
                    "large_float": 1.7976931348623157e308,  # Near max float
                }
            ]
        }
    ...
    def test_custom_json_options(self, tmp_path: Path):
        ...
        data = {"users": [{"name": "José", "age": 30, "city": "São Paulo"}]}
