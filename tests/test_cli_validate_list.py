...
class TestValidateSchemaCommand:
    ...
    def test_validate_nonexistent_directory(self):
        ...
        runner = CliRunner()
        result = runner.invoke(
            app, ["validate-schema", "--schema-dir", str(nonexistent_dir)]
        )
...
class TestListSchemasCommand:
    ...
    def test_list_schemas_detailed(self, multiple_schemas, temp_dirs):
        ...
        runner = CliRunner()
        result = runner.invoke(
            app, ["list-schemas", "--schema-dir", str(schema_dir), "--detailed"]
        )
    ...
    def test_list_nonexistent_directory(self):
        ...
        runner = CliRunner()
        result = runner.invoke(
            app, ["list-schemas", "--schema-dir", str(nonexistent_dir)]
        )
...
class TestVersionCommand:
    ...
    def test_main_help(self):
        ...
        assert result.exit_code == 0
        assert "Jafgen - A flexible synthetic data generator" in result.stdout
...
class TestCLIErrorHandling:
    ...
    def test_validate_with_discovery_error(self, temp_dirs):
        ...
        with patch("jafgen.cli.SchemaDiscoveryEngine") as mock_discovery:
            ...
            mock_discovery_instance.discover_and_load_schemas.side_effect = Exception(
                "Discovery failed"
            )
    ...
    def test_list_with_discovery_error(self, temp_dirs):
        ...
        with patch("jafgen.cli.SchemaDiscoveryEngine") as mock_discovery:
            ...
            runner = CliRunner()
            result = runner.invoke(
                app, ["list-schemas", "--schema-dir", str(schema_dir)]
            )
