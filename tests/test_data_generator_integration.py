...
class TestDataGeneratorLinkIntegration:
        ...
        schema = SystemSchema(
            ...
            entities={
                ...
                "orders": EntityConfig(
                    ...
                    attributes={
                        "id": AttributeConfig(type="uuid", unique=True),
                        "user_id": AttributeConfig(type="link", link_to="test_system.users.id"),
            ...
            entities={
                ...
                "products": EntityConfig(
                    ...
                    attributes={
                        "id": AttributeConfig(type="uuid", unique=True),
                        "name": AttributeConfig(type="text.word"),
                        "category_id": AttributeConfig(type="link", link_to="ecommerce.categories.id")
                    }
                ),
                "users": EntityConfig(
                    name="users",
                ...
                "orders": EntityConfig(
                    ...
                    attributes={
                        "id": AttributeConfig(type="uuid", unique=True),
                        "user_id": AttributeConfig(type="link", link_to="ecommerce.users.id"),
                        "product_id": AttributeConfig(type="link", link_to="ecommerce.products.id")
                    }
                )
            }
        )
    ...
    def test_generate_multiple_systems_with_cross_schema_links(self):
        ...
        orders_schema = SystemSchema(
            ...
            entities={
                "orders": EntityConfig(
                    ...
                    attributes={
                        "id": AttributeConfig(type="uuid", unique=True),
                        "user_id": AttributeConfig(type="link", link_to="users.users.id"),
        ...
        results = self.data_generator.generate_multiple_systems([users_schema, orders_schema])
        ...
        schema = SystemSchema(
            ...
            entities={
                "orders": EntityConfig(
                    ...
                    attributes={
                        "id": AttributeConfig(type="uuid", unique=True),
                        "user_id": AttributeConfig(type="link", link_to="test_system.nonexistent.id")
                    }
                )
            }
        )
        ...
        schema = SystemSchema(
            ...
            entities={
                "entity_a": EntityConfig(
                    ...
                    attributes={
                        "id": AttributeConfig(type="uuid", unique=True),
                        "b_ref": AttributeConfig(type="link", link_to="test_system.entity_b.id")
                    }
                ),
                "entity_b": EntityConfig(
                    ...
                    attributes={
                        "id": AttributeConfig(type="uuid", unique=True),
                        "a_ref": AttributeConfig(type="link", link_to="test_system.entity_a.id")
                    }
                )
            }
        )
        ...
        schema = SystemSchema(
            ...
            entities={
                ...
                "orders": EntityConfig(
                    ...
                    attributes={
                        "id": AttributeConfig(type="uuid", unique=True),
                        "user_id": AttributeConfig(type="link", link_to="test_system.users.id", required=False)
                    }
                )
            }
        )
        ...
        schema = SystemSchema(
            ...
            entities={
                "orders": EntityConfig(
                    ...
                    attributes={
                        "id": AttributeConfig(type="uuid", unique=True),
                        "user_id": AttributeConfig(type="link", link_to="test_system.users.id", required=True)
                    }
                )
            }
        )
        ...
        schema2 = SystemSchema(
            ...
            entities={
                "entity2": EntityConfig(
                    ...
                    count=1,
                    attributes={
                        "ref": AttributeConfig(type="link", link_to="nonexistent.entity.id")
                    }
                )
            }
        )
